...
//       if (prevSelected.includes(employeeName)) {
...
//       alert(`Task assigned to ${selectedEmployees.join(', ')} for project: ${selectedProjectData?.title}`);
//     } else {
...
//                   {selectedProjectData ? selectedProjectData.title : 'Select'}
//                 </span>
...
//                     checked={selectedEmployees.includes(employee.firstName + " " + employee.lastName)} // ✅ Check if in selected array
//                     onChange={() => handleEmployeeSelect(employee.firstName + " " + employee.lastName)} // ✅ Handle selection
...
//     if (selectedProject && selectedEmployees.length > 0) {
//       try {
//         // Here you can add API call to assign employees to the project
//         // For now, just showing alert

//         alert(`Task assigned to ${selectedEmployees.join(', ')} for project: ${selectedProjectData?.title}`);

//         // You can add API call here like:
//         // const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/task/assign`, {
...
//                         onChange={() => handleEmployeeSelect(employee.firstName + " " + employee.lastName)}
//                         className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
//                       />
//                       <div className="ml-4 flex items-center">
//                         <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-medium mr-4">
